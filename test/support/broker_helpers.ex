defmodule Ashtail.BrokerHelpers do
  @moduledoc """
  ...
  stores it where `Ashtail.Kafka.config/0` reads it from, and registers
  ...
  def override_brokers(brokers_string) when is_binary(brokers_string) do
    ...
    previous_config = Application.fetch_env!(:ashtail, :kafka_config)
    ...
    ExUnit.Callbacks.on_exit(fn ->
      ...
      Application.put_env(:ashtail, :kafka_config, previous_config)
    end)
