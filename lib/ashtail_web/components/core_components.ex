defmodule AshtailWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(AshtailWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(AshtailWeb.Gettext, "errors", msg, opts)
    # end
