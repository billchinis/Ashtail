defmodule AshtailWeb.TopicComponents do
  @moduledoc """
  ...
  import AshtailWeb.BrokerComponents, only: [broker_error: 1]

  @doc """
  Renders the topic sub-menu header. `topic` is a `%Ashtail.Kafka.Topic{}`
