defmodule Ashtail.Kafka.TopicReader do
  @moduledoc """
  The merged read engine behind `Ashtail.Kafka.read_topic/2`: a lazy
  ...
  predicate (`Ashtail.Kafka.Filter`), progress reporting (`on_progress`), a
  ...
  alias Ashtail.Kafka.{BrokerError, Client, Config, Filter, Message, Messages}
  ...
  `Ashtail.Kafka.read_topic/2` for the returned shape.
  """
