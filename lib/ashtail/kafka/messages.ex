defmodule Ashtail.Kafka.Messages do
  @moduledoc """
  ...
  alias Ashtail.Kafka.{BrokerError, Client, Config, Message}

  @min_max_bytes 1_048_576
  @max_max_bytes 8_388_608

  @doc """
  See `Ashtail.Kafka.fetch_messages/4` for the public shape. Resolves
  ...
  compaction gaps. This is the only read path `Ashtail.Kafka.TopicReader`
  ...
  @doc """
  See `Ashtail.Kafka.produce/3` for the public shape. `partition == nil`
