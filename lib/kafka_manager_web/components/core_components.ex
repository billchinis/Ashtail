defmodule KafkaManagerWeb.CoreComponents do
  @moduledoc """
      ...
      <table class="table">
        ...
        <tbody id={@id} phx-update={@stream? && "stream"}>
          ...
          <tr
            ...
            class={[
              "hover:bg-base-200/60 max-sm:flex max-sm:flex-wrap max-sm:gap-x-3 max-sm:gap-y-1 max-sm:px-4 max-sm:py-3",
          ...
          >
            ...
            <td :if={@action != []} class="py-3 px-4 max-sm:p-0 w-0 font-semibold max-sm:border-b-0">
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(KafkaManagerWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(KafkaManagerWeb.Gettext, "errors", msg, opts)
    # end
